...
```python
# Input: October 28, 2024 00:00:00 UTC
# Anchor: May 16, 2025 21:25:00 UTC = 3,079,913,916,391.82 CU-years

delta_days = 200  # Days between Oct 28 and May 16
delta_hours = 21
delta_minutes = 25
total_seconds = (delta_days * 86400) + (delta_hours * 3600) + (delta_minutes * 60)  # = 17,361,900

# CTOM phase scaling (logarithmic)
ratio = 1 + log(1.0)  # ≈1.0 near anchor
cu_delta = Decimal(total_seconds) / Decimal(31556952)  # ≈0.5501 CU-years

# Final calculation
cu_time = Decimal("3079913916391.82") - cu_delta  # = 3,079,913,916,391.2699
```
