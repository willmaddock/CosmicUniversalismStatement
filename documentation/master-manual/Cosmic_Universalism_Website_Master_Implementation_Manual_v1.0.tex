...
% Current stable release verified: July 21, 2026
% ============================================================
...
\newcommand{\DocumentSubtitle}{Website, CU-Time, CUCII, AI Project Governance, and LaTeX Authoring Standard}
...
\newcommand{\PriorReleaseTag}{website-v1.2-cucii-release}
\newcommand{\PriorReleaseCommit}{ae16ae7}
\newcommand{\DocumentVersion}{1.0}
\newcommand{\VerificationDate}{July 21, 2026}
...
\hypersetup{
    ...
    pdfsubject={Unified Astro website, CU-Time, CUCII, ChatGPT/Codex governance, release workflow, and LaTeX documentation standard},
    pdfkeywords={Cosmic Universalism, Astro, TypeScript, Vitest, CU-Time,
...
\fancyfoot[R]{\small Release: \texttt{v1.3}}
...
Cosmic Breath Time Converter, the CUCII Prompt Studio, the Aurelius
Claude-proven configuration, ChatGPT/Codex project governance, release
operations, and the canonical LaTeX style for future Cosmic Universalism
manuals.}
...
Current stable release & \texttt{\CurrentReleaseTag} \\
Current release commit & \texttt{\CurrentReleaseCommit} \\
...
Verified quality gate & 106 tests across 17 files; Astro static build; 8 pages \\
...
Current stable release & \release{\CurrentReleaseTag} at \release{\CurrentReleaseCommit} \\
Prior stable release & \release{\PriorReleaseTag} at \release{\PriorReleaseCommit} \\
...
\begin{purposebox}
This document replaces the need to begin every new project chat with three
separate implementation manuals. It preserves their essential technical,
mathematical, prompt-architecture, testing, and release rules while adding the
current v1.3 release state, the Aurelius and Alexa+ work, reusable ChatGPT/Codex
project-file templates, and the canonical LaTeX house style for future manuals.
\end{purposebox}
...
\begin{enumerate}
    ...
    \item Current release tag and commit listed in this manual.
...
\begin{enumerate}
    ...
    \item Part 8: Testing and acceptance.
    \item Part 9: Git and release operations.
    \item Part 10 when creating or revising a manual.
\end{enumerate}
...
Current release & \release{website-v1.3-aurelius-release} \\
Current release commit & \release{5a56085} \\
...
website-v1.3-aurelius-release

Current stable release commit:
5a56085
...
website-vX.Y-<name>-release  permanent stable recovery tag
\end{codebox}

\subsection{Current verified release history}

\begin{tabularx}{\textwidth}{L{2.3in}L{1.0in}Y}
\toprule
\textbf{Release tag} & \textbf{Commit} & \textbf{Meaning} \\
\midrule
...
Feature-history commits include:

\begin{itemize}
    \item \release{0ad51dd}: CUCII AI exploration and prompt studio.
    \item \release{3bd4b32}: Aurelius Claude preset and Alexa+ support.
\end{itemize}

\subsection{Current verification record}

At the v1.3 release checkpoint:

\begin{itemize}
    \item 106 automated tests passed across 17 test files.
    \item The Astro production build completed successfully.
    \item Eight static pages were generated.
    \item The CUCII and CU-Time routes were both retained.
    \item The \branchname{website} branch and annotated release tag were pushed.
    \item The working tree was clean and synchronized.
\end{itemize}

\subsection{Historical manuals and current state}

The three source manuals documented controlled development at different
times:
...
The current release expects eight pages, including
\filepath{/cu-time/index.html} and \filepath{/cu-intelligence/index.html} in
the static build output.

% ============================================================
\section{Part 6 - Cosmic Breath Time Converter}
% ============================================================
...
\subsection{CU framework timing context}

The source research describes a full Cosmic Breath of approximately
...
Early and middle tom durations use:

\[
T(n)=\frac{2.8\times10^{12}}{2^n}.
\]

Deep sub-tom durations use the CU source rule:

\[
T(n)=427{,}350\times 10^{-(n-16)}\ \mathrm{years}.
\]

Y-TOM is described as 27 ns and Z-TOM as one second. These statements are CU
model content and must be distinguished from empirical standards and
measurements.
...
% ============================================================
\section{Part 7 - CUCII Prompt Studio}
% ============================================================
...
% ============================================================
\section{Part 8 - Aurelius, Claude, and Control-Specimen Rules}
% ============================================================
...
% ============================================================
\section{Part 9 - Testing, Accessibility, and Acceptance}
% ============================================================
...
The v1.3 release passed:

\begin{codebox}{Current release gate}
...
% ============================================================
\section{Part 10 - Git Commit, Merge, Tag, and Recovery Operations}
% ============================================================
...
\subsection{Annotated release tag}

\begin{commandbox}{Create and push a release tag}
git tag -a website-vX.Y-<release-name> \
  -m "Cosmic Universalism Website vX.Y - <release summary>"

git show --no-patch --decorate website-vX.Y-<release-name>
git tag --points-at HEAD

git push origin website-vX.Y-<release-name>
\end{commandbox}
...
git ls-remote --tags origin website-vX.Y-<release-name>
git status --short --branch
\end{commandbox}
...
git switch website
git switch -c feature/<new-feature> website-vX.Y-<release-name>
\end{commandbox}

% ============================================================
\section{Part 11 - LaTeX House Style for Future Manuals}
% ============================================================
...
% ============================================================
\section{Part 12 - Troubleshooting and Decision Rules}
% ============================================================
...
git tag -a website-vX.Y-<name>-release \
  -m "Cosmic Universalism Website vX.Y - <summary>"

git push origin website-vX.Y-<name>-release
\end{commandbox}
...
\begin{itemize}
    ...
    \item verified Git, test, build, merge, and release outputs through
          \release{website-v1.3-aurelius-release}.
\end{itemize}
